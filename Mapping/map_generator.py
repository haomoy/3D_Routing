...
def run(context):
    ...
    try:
        ...
        ui.messageBox('X max-min ' + bndBox.minPoint.x + '-' + bndBox.maxPoint.x)
        ui.messageBox('Y max-min ' + bndBox.minPoint.y + '-' + bndBox.maxPoint.y)
        ui.messageBox('Z max-min ' + bndBox.minPoint.z + '-' + bndBox.maxPoint.z)
